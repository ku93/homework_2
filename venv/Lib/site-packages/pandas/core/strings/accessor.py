    ...
    def _wrap_result(
        ...
        if expand is None:
            ...
            if isinstance(result.dtype, ArrowDtype):
                ...
                result = {label: ArrowExtensionArray(pa.array(res)) for label, res in zip(labels, result.T)}
    ...
    def _get_series_list(self, others):
        ...
        if isinstance(others, ABCSeries):
            ...
            try:
                ...
                if all(
                    isinstance(x, (ABCSeries, ABCIndex, ExtensionArray)) or (isinstance(x, np.ndarray) and x.ndim == 1)
                    for x in others
                ):
                    los: list[Series] = []
