...
def is_signed_integer_dtype(arr_or_dtype) -> bool:
    ...
    False
    """
    return _is_dtype_type(arr_or_dtype, _classes_and_not_datetimelike(np.signedinteger)) or _is_dtype(
...
def is_unsigned_integer_dtype(arr_or_dtype) -> bool:
    ...
    True
    """
    return _is_dtype_type(arr_or_dtype, _classes_and_not_datetimelike(np.unsignedinteger)) or _is_dtype(
...
def is_int64_dtype(arr_or_dtype) -> bool:
    ...
    # GH#52564
    warnings.warn(
        "is_int64_dtype is deprecated and will be removed in a future " "version. Use dtype == np.int64 instead.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def is_numeric_dtype(arr_or_dtype) -> bool:
    ...
    False
    """
    return _is_dtype_type(arr_or_dtype, _classes_and_not_datetimelike(np.number, np.bool_)) or _is_dtype(
