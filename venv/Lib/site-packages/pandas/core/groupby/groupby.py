...
class BaseGroupBy(PandasObject, SelectionMixin[NDFrameT], GroupByIndexingMixin):
    ...
    def grouper(self) -> ops.BaseGrouper:
        warnings.warn(
            f"{type(self).__name__}.grouper is deprecated and will be removed in a " "future version of pandas.",
    ...
    def shift(
        ...
        for period in periods:
            ...
            if freq is not None or axis != 0:
                f = lambda x: x.shift(period, freq, axis, fill_value)  # pylint: disable=cell-var-from-loop
