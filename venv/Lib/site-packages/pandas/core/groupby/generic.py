...
class SeriesGroupBy(GroupBy[Series]):
    ...
    def _get_data_to_aggregate(self, *, numeric_only: bool = False, name: str | None = None) -> SingleManager:
        ...
        if numeric_only and not is_numeric_dtype(ser.dtype):
            ...
            raise TypeError(
                f"Cannot use {kwd_name}=True with " f"{type(self).__name__}.{name} and non-numeric dtypes."
            )
        return single
    ...
    def value_counts(
        ...
        if bins is not None:
            ...
            _, idx = get_join_indexers(left, right, sort=False, how="left")  # type: ignore[arg-type]
            if idx is not None:
...
class DataFrameGroupBy(GroupBy[DataFrame]):
    ...
    def dtypes(self) -> Series:
        ...
        return self._python_apply_general(lambda df: df.dtypes, self._selected_obj)  # type: ignore[return-value]
