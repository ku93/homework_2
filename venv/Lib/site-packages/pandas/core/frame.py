...
class DataFrame(NDFrame, OpsMixin):
    ...
    def from_dict(
        ...
        if orient == "index":
            ...
            raise ValueError(
                f"Expected 'index', 'columns' or 'tight' for orient parameter. " f"Got '{orient}' instead"
            )
    ...
    def duplicated(
        ...
        if subset is None:
            ...
            not np.iterable(subset) or isinstance(subset, str) or isinstance(subset, tuple) and subset in self.columns
        ):
            subset = (subset,)
