...
class ArrowExtensionArray(
    ...
    def _evaluate_op_method(self, other, op, arrow_funcs):
        ...
        if pa.types.is_string(pa_type) or pa.types.is_large_string(pa_type) or pa.types.is_binary(pa_type):
            ...
            pa.types.is_string(other.type) or pa.types.is_binary(other.type) or pa.types.is_large_string(other.type)
    ...
    def _str_extract(self, pat: str, flags: int = 0, expand: bool = True):
        ...
        if expand:
            return {
                col: type(self)(pc.struct_field(result, [i])) for col, i in zip(groups, range(result.type.num_fields))
            }
        else:
    ...
    def _dt_hours(self):
        return type(self)(
            pa.array(
                [td.components.hours if td is not NaT else None for td in self._to_timedeltaarray()],
                type=pa.int32(),
            )
        )
    ...
    def _dt_minutes(self):
        return type(self)(
            pa.array(
                [td.components.minutes if td is not NaT else None for td in self._to_timedeltaarray()],
                type=pa.int32(),
            )
        )
    ...
    def _dt_milliseconds(self):
        return type(self)(
            pa.array(
                [td.components.milliseconds if td is not NaT else None for td in self._to_timedeltaarray()],
                type=pa.int32(),
            )
        )
