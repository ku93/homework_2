...
class DatetimeLikeArrayMixin(OpsMixin, NDArrayBackedExtensionArray):  # type: ignore[misc]
    ...
    def _validation_error_message(self, value, allow_listlike: bool = False) -> str:
        ...
        if allow_listlike:
            ...
            msg = f"value should be a '{self._scalar_type.__name__}' or 'NaT'. " f"Got {msg_got} instead."
        return msg
    ...
    def _add_timedeltalike(self, other: Timedelta | TimedeltaArray):
        ...
        return type(self)._simple_new(res_values, dtype=self.dtype, freq=new_freq)  # type: ignore[arg-type]
