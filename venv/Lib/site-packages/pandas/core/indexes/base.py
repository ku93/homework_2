...
class Index(IndexOpsMixin, PandasObject):
    ...
    def _validate_sort_keyword(self, sort):
        if sort not in [None, False, True]:
            raise ValueError(
                "The 'sort' keyword only takes the values of " f"None, True, or False; {sort} was passed."
            )
    ...
    def equals(self, other: Any) -> bool:
        ...
        * The order of the elements inside the Index object.
        ...
        if isinstance(self.dtype, StringDtype) and self.dtype.storage == "pyarrow_numpy" and other.dtype != self.dtype:
    ...
    def insert(self, loc: int, item) -> Index:
        ...
        if using_pyarrow_string_dtype() and is_string_dtype(out.dtype) and new_values.dtype == object:
