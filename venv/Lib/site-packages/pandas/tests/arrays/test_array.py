...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ["a", None],
            "string",
            pd.StringDtype().construct_array_type()._from_sequence(["a", None], dtype=pd.StringDtype()),
        ),
        (
            ["a", None],
            pd.StringDtype(),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            DatetimeArray._from_sequence(["2000", "2001"], dtype=pd.DatetimeTZDtype(tz="CET", unit="ns")),
        ),
        (
            [
        ...
        (
            ["a", "b"],
            pd.StringDtype().construct_array_type()._from_sequence(["a", "b"], dtype=pd.StringDtype()),
        ),
        (
            ["a", None],
            pd.StringDtype().construct_array_type()._from_sequence(["a", None], dtype=pd.StringDtype()),
