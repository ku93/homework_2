...
if not pa_version_under10p1:
    ...
    ALL_REAL_PYARROW_DTYPES_STR_REPR = ALL_INT_PYARROW_DTYPES_STR_REPR + FLOAT_PYARROW_DTYPES_STR_REPR
else:
...
ALL_REAL_NULLABLE_DTYPES = FLOAT_NUMPY_DTYPES + ALL_REAL_EXTENSION_DTYPES + ALL_REAL_PYARROW_DTYPES_STR_REPR
