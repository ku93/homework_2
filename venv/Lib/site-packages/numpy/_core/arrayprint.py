...
from .multiarray import array, dragon4_positional, dragon4_scientific, datetime_as_string, datetime_data, ndarray
...
def _make_options_dict(
    ...
    *legacy* and sanity checks.
    ...
    if legacy == False:
        ...
        warnings.warn(
            "legacy printing option can currently only be '1.13', '1.21', " "'1.25', or `False`", stacklevel=3
        )
