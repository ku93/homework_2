...
_SeriesLikeComplex_co: TypeAlias = (
    _SupportsArray[np.integer[Any] | np.inexact[Any] | np.bool] | Sequence[_ComplexLike_co]
)
...
_ArrayLikeCoef_co: TypeAlias = (
    npt.NDArray[np.number[Any] | np.bool | np.object_] | _ArrayLikeNumber_co | _ArrayLikeCoefObject_co
)
