...
M   33  21.99
    ...
    def test_invalid_converter(self):
        ...
        kwargs = dict(converters={2: strip_per, 3: strip_rand}, delimiter=",", dtype=None, encoding="bytes")
    ...
    def test_inconsistent_dtype(self):
        ...
        kwargs = dict(delimiter=",", converters=converters, dtype=[(_, int) for _ in "abcde"], encoding="bytes")
    ...
    def test_recfromcsv(self):
        #
        data = TextIO("A,B\n0,1\n2,3")
        kwargs = dict(missing_values="N/A", names=True, case_sensitive=True, encoding="bytes")
