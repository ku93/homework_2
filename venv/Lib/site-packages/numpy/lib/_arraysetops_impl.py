...
def unique(ar, return_index=False, return_inverse=False, return_counts=False, axis=None, *, equal_nan=True):
    ...
    * the number of times each unique value comes up in the input array
    ...
    if axis is None:
        ret = _unique1d(
            ar, return_index, return_inverse, return_counts, equal_nan=equal_nan, inverse_shape=ar.shape, axis=None
        )
...
def _unique1d(
    ar, return_index=False, return_inverse=False, return_counts=False, *, equal_nan=True, inverse_shape=None, axis=None
):
    """
