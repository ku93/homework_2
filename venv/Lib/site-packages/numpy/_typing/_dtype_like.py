...
_DTypeLikeBool: TypeAlias = (
    type[bool] | type[np.bool] | np.dtype[np.bool] | _SupportsDType[np.dtype[np.bool]] | _BoolCodes
)
...
_DTypeLikeTD64: TypeAlias = (
    type[np.datetime64] | np.dtype[np.datetime64] | _SupportsDType[np.dtype[np.datetime64]] | _DT64Codes
)
_DTypeLikeStr: TypeAlias = (
    type[str] | type[np.str_] | np.dtype[np.str_] | _SupportsDType[np.dtype[np.str_]] | _StrCodes
)
...
_DTypeLikeVoid: TypeAlias = (
    type[np.void] | np.dtype[np.void] | _SupportsDType[np.dtype[np.void]] | _VoidCodes | _VoidDTypeLike
)
